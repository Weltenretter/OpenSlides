...
export class ThemeService {
     ...
     */
    public static STANDARD_LOGO = '/assets/img/wr-logo.svg'; // '/assets/img/openslides-logo.svg';

    /**
     * Constant path of the logo with white colors for dark themes.
     */
    public static STANDARD_LOGO_DARK_THEME = '/assets/img/wr-logo-dark.svg'; // '/assets/img/openslides-logo-dark.svg';
